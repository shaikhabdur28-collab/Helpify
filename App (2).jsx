...
function App() {
  ...
  useEffect(() => {
    ...
    const savedGeminiKey = localStorage.getItem(STORAGE_KEYS.geminiKey)
    if (savedGeminiKey) {
  ...
  async function sendChatMessage() {
    ...
    if (!apiKey) {
      ...
      setChatMessages((prev) => [...prev, {
        ...
        role: 'assistant',
        text: 'Add your Gemini API key in the chatbot settings to enable AI replies.',
      }])
      return
    }
        ...
        <section className="card">
          ...
          <div className="chat-shell">
            ...
            <div className="chat-settings">
              ...
              <div className="button-row">
                <button className="secondary" type="button" onClick={saveGeminiKey}>
                  Save key
                </button>
